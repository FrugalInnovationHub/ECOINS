...
class Blue_Score_Disp extends PositionComponent with HasGameRef {
  ...
  Future<void> onLoad() async {
    ...
    BlueLevel1
      ...
      ..position = Vector2(ratio*307, ratio*400);
    ...
    BlueLevel3
      ...
      ..size = Vector2(ratio*100, ratio*40)
      ..position = Vector2(ratio*300, ratio*320);

    add(BlueLevel3);

    BlueLevel4
      ..sprite = await gameRef.loadSprite('04.png')
      ..size = Vector2(ratio*98, ratio*40)
  ...
  void changeSpriteLevel() {
      i = i + 4;
      print(i);
      BlueLevel1.size = Vector2(ratio* 85, ratio*(40 - i));
  }
}
