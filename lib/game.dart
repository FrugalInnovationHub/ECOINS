...
class EcoinsGame extends FlameGame with HasTappables, HasCollisionDetection{
  ...
  late var ratio;
  late OpacityEffect h_opacity_blick_effect_yellow;
  late OpacityEffect h_opacity_blick_effect_grey;
  ...
  Future<void> onLoad() async {
    ...
    await add(lock);
    h_opacity_blick_effect_yellow = OpacityEffect.to(2, EffectController(duration: 1, repeatCount: 3, startDelay: 0));
    h_opacity_blick_effect_grey = OpacityEffect.to(2, EffectController(duration: 1, repeatCount: 3, startDelay: 0));
    ...
    if(child is Trash_Item && type == ChildrenChangeType.removed){
      ...
      if(blue_score_disp.blue_score == 40){
        ...
        for (var i in allLock){
          if(i.type == "yellow"){
            i.removeFromParent();
            _basureros.Yellow.add(h_opacity_blick_effect_yellow);
      ...
      if(yellow_score_disp.yellow_score == 40){
        ...
        for (var i in allLock){
          if(i.type == "gray"){
            i.removeFromParent();
            _basureros.Grey.add(h_opacity_blick_effect_grey);
            Future.delayed(Duration(seconds: 3), () {
